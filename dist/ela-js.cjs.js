  ...
  _createClass(ELA_JS, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log(tableKey); // this should only work locally, fortmatic would use a different path
    ...
    value: function () {
      var _insertRow = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(tableName, cols, values, options) {
        var id, idKey, tableKey, idTableKey, i, fieldIdTableKey, _fieldKey;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 9:
                ...
                _fieldKey = keccak256(cols[i]);
                _context2.next = 15;
                return this.ephemeralInstance.methods.insertVal(tableKey, idTableKey, fieldIdTableKey, idKey, _fieldKey, id, values[i]).send({
    ...
    value: function () {
      var _getVal2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(tableName, id, fieldName) {
        var fieldIdTableKey, result, fieldType;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return this.ozInstance.methods.getRowValue(fieldIdTableKey).call();

              case 3:
                result = _context4.sent;
                // TODO: type parsing? How to ensure this is fresh?
                // and so what if it isn't? We can't really change a field type right?
                fieldType = this.schema[tableKey][fieldKey].type;
                _context4.t0 = fieldType;
                _context4.next = _context4.t0 === constants.FIELD_TYPE.NUMBER ? 8 : 10;
                break;
